...
<div align="center">
  ...
  <p>File manager plugin. Inspect file signatures and verify cryptographic checksums</p>
...
File Inspector checks any readable regular file supplied by the file manager through temporary read-only content URI access. It reports file metadata, the first 64 header bytes, and multiple digests without changing the source file.
...
Version 1 provides a read-only single-file overflow action in the main file manager.

Host build 5268 or later is required.
